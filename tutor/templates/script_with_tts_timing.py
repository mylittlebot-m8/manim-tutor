...
class TeachingScene(Scene):
    ...
    def play_scene_1(self):
        ...
        # 计算已用动画时间
        animation_duration = self.time - start_time
        
        # 等待到音频结束
        self.wait_for_audio(1, animation_duration)
    ...
    def play_scene_2(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(2, animation_duration)
    ...
    def play_scene_3(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(3, animation_duration)
    ...
    def play_scene_4(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(4, animation_duration)
    ...
    def play_scene_5(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(5, animation_duration)
    ...
    def play_scene_6(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(6, animation_duration)
    ...
    def play_scene_7(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(7, animation_duration)
    ...
    def play_scene_8(self):
        ...
        animation_duration = self.time - start_time
        self.wait_for_audio(8, animation_duration)
