"""
抛物线综合题 - 完整解题动画（带音频）
题目：已知抛物线 y = ax² + bx + 4，B(3,0)，对称轴x=1
"""
...
class ParabolaProblem(Scene):
    ...
    def construct(self):
        ...
        # 执行各幕
        self.scene_1_title()      # 第1幕：题目展示
        self.scene_2_find_a()     # 第2幕：求点A坐标
        self.scene_3_equation()   # 第3幕：求解析式
        self.scene_4_answer()     # 第4幕：最终答案
    ...
    def scene_1_title(self):
        ...
        problem = VGroup(
            ...
            Text("(1) 求解析式", font_size=26, color="#2ecc71"),
            Text("(2) 求点P使∠PCB = ∠ABC", font_size=26, color="#2ecc71")
    ...
    def scene_4_answer(self):
        ...
        ans1_label = Text("(1)", font_size=30)
        ans1_form = MathTex(r"y = -\frac{4}{3}x^2 + \frac{8}{3}x + 4", font_size=30)
        ...
        ans2_or = Text("或", font_size=26, color="yellow")
        ans2_p2 = MathTex(r"P_2\left(\frac{7}{3}, \frac{20}{9}\right)", font_size=28)
