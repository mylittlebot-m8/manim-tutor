...
class ParabolaProblem(Scene):
    def construct(self):
        ...
        subtitle = Text("y = ax² + bx + 4, B(3,0), 对称轴x=1", font_size=28, color="#f39c12")
        ...
        calc = MathTex("\\frac{x_A + 3}{2} = 1 \\Rightarrow x_A = -1", font_size=32)
        result1 = MathTex("A(-1, 0)", font_size=36, color="#2ecc71")
        ...
        eq1 = MathTex("a - b = -4", font_size=28)
        eq2 = MathTex("-\\frac{b}{2a} = 1 \\Rightarrow b = -2a", font_size=28)
        sol = MathTex("a = -\\frac{4}{3}, \\quad b = \\frac{8}{3}", font_size=28, color="#2ecc71")
        final = MathTex("y = -\\frac{4}{3}x^2 + \\frac{8}{3}x + 4", font_size=32, color="#e74c3c")
        ...
        # 第4幕：答案
        answer = VGroup(
            Text("答案:", font_size=40, color="#3498db"),
            MathTex("(1) \\; y = -\\frac{4}{3}x^2 + \\frac{8}{3}x + 4", font_size=30),
            MathTex("(2) \\; P_1(2, 4) \\text{ 或 } P_2(\\frac{7}{3}, \\frac{20}{9})", font_size=28)
