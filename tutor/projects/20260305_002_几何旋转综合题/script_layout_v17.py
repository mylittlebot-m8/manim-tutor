"""
Geometry Rotation Problem - Layout Version 17
Combined modifications:
1. Title X position moved right 5%
2. Solution and formula display moved right 15% AND down 15%
3. Font sizes: 28/32/36
4. Spacing: 0.45/0.55
5. Last scene split into two scenes (Scene 9: Answer summary, Scene 10: Solution method summary)
"""
...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # Scene 1 content positions
        self.KNOWN_POS = LEFT * 3.5 + DOWN * 0.5
        self.PROBLEM_POS = RIGHT * 3.5 + DOWN * 0.5
        
        # Title position: moved right 5%
        # Right 5%: RIGHT * 0.05 * 18 = RIGHT * 0.9
        # Original: LEFT * 4.75 + UP * 3.567
        # New: LEFT * 4.75 + RIGHT * 0.9 + UP * 3.567 = LEFT * 3.85 + UP * 3.567
        self.TITLE_POS = LEFT * 3.85 + UP * 3.567
        
        # Formula area start position: moved right 15% AND down 15%
        # Right 15%: RIGHT * 0.15 * 9.0 = RIGHT * 1.35
        # Down 15%: DOWN * 0.15 * 6.5 = DOWN * 0.975
        # Original: RIGHT * 0.25 + UP * 1.85
        # New: RIGHT * 0.25 + RIGHT * 1.35 + UP * 1.85 - DOWN * 0.975 = RIGHT * 1.6 + UP * 0.875
        self.FORMULA_START_POS = RIGHT * 1.6 + UP * 0.875
        ...
        # 10 scenes (last scene split into two)
        self.scene_1_intro()
        ...
        self.scene_9_answer()      # Scene 9: Answer summary
        self.scene_10_summary()    # Scene 10: Solution method summary
    ...
    def scene_9_answer(self):
        """Scene 9: Answer summary"""
        ...
        answer.move_to(self.FORMULA_START_POS)
        
        self.play(Write(answer))
        self.wait_for_audio(9, self.time - start_time)
        self.play(FadeOut(placeholder), FadeOut(answer))
    
    def scene_10_summary(self):
        """Scene 10: Solution method summary"""
        self.add_scene_audio(10)
        start_time = self.time
        self.show_layout("解题方法总结")
        ...
        self.wait_for_audio(10, self.time - start_time)
