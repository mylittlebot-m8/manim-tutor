...
几何旋转综合题 - 精确定位布局版 v8
根据用户反馈修改：
1. 标题：起始 Y 坐标往上 72px（1080p 中 72px = 0.067）
2. 右边公式区：起始位置往上 120px，往左 280px
3. 加大展示空间，检查文字重叠和隐藏
"""
...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # 公式区域起始位置：往上 120px，往左 280px
        # 1080p 中 120px ≈ 0.111, 280px ≈ 0.259
        self.FORMULA_START_POS = self.FORMULA_CENTER + UP * 0.111 + LEFT * 0.259
