...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # 公式区域起始位置：继续往左往上移动
        # 往左 40%: LEFT * 0.4 * 9.0 = LEFT * 3.6
        # 往上 40%: UP * 0.4 * 6.5 = UP * 2.6
        # 所以新位置 = RIGHT * 4.75 + LEFT * 3.6 + DOWN * 1.4 + UP * 2.6
        # = RIGHT * 1.15 + UP * 1.2
        self.FORMULA_START_POS = RIGHT * 1.15 + UP * 1.2
        
        # 字体大小加大 50%：从 24 到 36，从 28 到 42，从 32 到 48
        self.FONT_SMALL = 36
        self.FONT_MEDIUM = 42
        self.FONT_LARGE = 48
        
        # 间距加大 50%：从 0.35 到 0.525
        self.BUFF_SMALL = 0.45
        self.BUFF_MEDIUM = 0.525
