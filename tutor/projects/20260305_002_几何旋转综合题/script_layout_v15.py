"""
Geometry Rotation Problem - Layout Version 15
Based on v13 with modifications:
1. Solution and formula display moved right 15%
2. Last scene split into two scenes (Scene 9: Answer summary, Scene 10: Solution method summary)
"""
...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # Formula area start position: moved right 15%
        # Right 15%: RIGHT * 0.15 * 9.0 = RIGHT * 1.35
        # Original: RIGHT * 0.25 + UP * 0.875
        # New: RIGHT * 0.25 + RIGHT * 1.35 + UP * 0.875 = RIGHT * 1.6 + UP * 0.875
