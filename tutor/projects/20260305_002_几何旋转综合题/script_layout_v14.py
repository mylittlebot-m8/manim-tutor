...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # 公式区域起始位置：往右 15%
        # 往右 15%: RIGHT * 0.15 * 9.0 = RIGHT * 1.35
        # 原位置：RIGHT * 0.25 + UP * 0.875
        # 新位置：RIGHT * 0.25 + RIGHT * 1.35 + UP * 0.875 = RIGHT * 1.6 + UP * 0.875
        ...
        self.scene_9_answer()      # 第 9 幕：答案汇总
        self.scene_10_summary()    # 第 10 幕：解题方法总结
