"""
Geometry Rotation Problem - Layout Version 16
Based on v13 final with modifications:
1. Title X position moved right 5%
2. Solution and formula display moved down 15%
...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # Formula area start position: moved down 15%
        # Down 15%: DOWN * 0.15 * 6.5 = DOWN * 0.975
        # Original: RIGHT * 0.25 + UP * 1.85
        # New: RIGHT * 0.25 + UP * 1.85 - DOWN * 0.975 = RIGHT * 0.25 + UP * 0.875
