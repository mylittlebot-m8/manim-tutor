...
class GeometryRotationProblem(Scene):
    ...
    def construct(self):
        ...
        # 公式区域起始位置：加大显示区间，往左往上移动更多
        # 往左 50%: LEFT * 0.5 * 9.0 = LEFT * 4.5
        # 往上 50%: UP * 0.5 * 6.5 = UP * 3.25
        # 所以新位置 = RIGHT * 4.75 + LEFT * 4.5 + DOWN * 1.4 + UP * 3.25
        # = RIGHT * 0.25 + UP * 1.85
        self.FORMULA_START_POS = RIGHT * 0.25 + UP * 1.85
