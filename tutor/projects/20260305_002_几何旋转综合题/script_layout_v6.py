...
class GeometryRotationProblem(Scene):
    ...
    def scene_1_intro(self):
        ...
        problem = Tex(
            r"\textbf{求解：}",
            r"(1) \text{求证：}\angle ABE = 90^\circ",
            r"(2) \text{当} D \text{为} AB \text{中点时，求} BE",
            r"(3) CE^2 = 2BD \cdot AD\text{，求} CE \text{最小值}",
            font_size=24,
            color="#2ecc71"
    ...
    def scene_2_rotation(self):
        ...
        hint = Tex(
            r"\textbf{思路：}",
            r"\triangle CDE \text{可看作} \triangle CDB",
    ...
    def scene_3_proof(self):
        ...
        start_time = self.time
        self.show_layout(r"\text{证明：}\angle ABE = 90^\circ")
    ...
    def scene_4_q2(self):
        ...
        start_time = self.time
        self.show_layout(r"\text{第} (2) \text{问：}D \text{为} AB \text{中点}")
    ...
    def scene_6_q3_similar(self):
        ...
        start_time = self.time
        self.show_layout(r"\text{第} (3) \text{问①：相似三角形}")
    ...
    def scene_7_q3_proof(self):
        ...
        start_time = self.time
        self.show_layout(r"\text{证明：}CE^2 = 2BD \cdot AD")
    ...
    def scene_8_q3_minimum(self):
        ...
        start_time = self.time
        self.show_layout(r"\text{求} CE \text{最小值}")
