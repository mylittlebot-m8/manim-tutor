...
**画面**: 深色背景，题目文字逐行显示
**字幕**: "抛物线_修复版"
**读白**: "已知抛物线 y = ax² + bx + 4，B(3,0)，对称轴 x=1。(1) 求解析式；(2)∠PCB=∠ABC，求 P 点。"
**动画**: 
- 0.0s: 标题淡入
- 1.0s: 题目条件逐行显示
**目的**: 引入题目，让学生了解问题背景
...
|------|--------|----------|------|--------|------|
| 1 | audio_001_题目朗读.wav | "已知抛物线 y = ax² + bx + 4，B(3,0)，对称轴 x=1。(1) 求解析式；(2)∠PCB=∠ABC，求 P 点。" | | Nofish | 平和 |
...
已知抛物线 y = ax² + bx + 4，B(3,0)，对称轴 x=1。(1) 求解析式；(2)∠PCB=∠ABC，求 P 点。
